...
public class GUIUtil {
    private static final String imgPath = "src/smograin/resources/static/img/";
    ...
    public static boolean isPath(String path,Component c)
    {
        if(new File(path).exists()) return true;
        JOptionPane.showMessageDialog(c,"文件不存在");
        return false;
    }
